  ...
  setup() {
    ...
    const filteredAssets = computed(() => {
      return assets.value.filter(asset => {
        ...
        const matchesCapability = !capabilityFilter.value || 
          (capabilityFilter.value === 'lora' && asset.lora_training?.enabled) ||
          (capabilityFilter.value === 'ai' && asset.ai_engine?.enabled)
