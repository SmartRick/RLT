        ...
        async saveConfig() {
            try {
                const config = {
                    ...
                    training: {
                        learning_rate: parseFloat(this.configForm.training.learning_rate),
                        steps: parseInt(this.configForm.training.steps),
                        batch_size: parseInt(this.configForm.training.batch_size)
                    }
                };
