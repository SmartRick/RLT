...
from ..schemas.asset import AssetCreate, AssetUpdate, Asset, LoraTrainingConfig, AIEngineConfig
        ...
        with get_db() as db:
            ...
            return [
                Asset(
                    ...
                    lora_training=LoraTrainingConfig(**asset.lora_training),
                    ai_engine=AIEngineConfig(**asset.ai_engine)
                ) 
                for asset in assets
            ]
